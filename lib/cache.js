...
export const TTL = {
  ...
  odds_inplay: 10,
  fixture_xg: 30 * 60,
  fixture_predictions: 30 * 60,
  fixture_news: 60 * 60,
  fixture_expected_lineups: 60 * 60,
  standings: 6 * 60 * 60,
  standings_round: 6 * 60 * 60,
  standings_corrections: 24 * 60 * 60,
  standings_live: 30,
  fixture_commentaries: 30,
  fixture_match_facts: 30 * 60,
  team_squads: 24 * 60 * 60,
  team_squads_fallback: 24 * 60 * 60,
  season_topscorers: 6 * 60 * 60,
  team_rankings: 24 * 60 * 60,
  team_schedules: 6 * 60 * 60,
  fixture_transfer_rumours: 6 * 60 * 60,
};
